...
-----END PRIVATE KEY-----
    ...
    {
        $plainText = Str::random(100000); //100,000 chars should be a good test chars message - to long to deal with under openssl standards!!!
    ...
    public function testMessageEncryptionForLongerMessagesWithEncryptedKey()
    {
        ...
        // Setup our secured public / private keypair
        $rsa = EloquentAsyncKeys::setPassword($this->password)->create(); // creates new keys, with the private key password-protected
